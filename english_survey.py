...
def load_data(language):
    if language == 'HINDI FEEDBACK ANALYSIS':
        return pd.read_excel('C:/Users/Admin/Desktop/RED DOT/HINDI.xlsx')
    elif language == 'ENGLISH FEEDBACK ANALYSIS':
        return pd.read_excel('C:/Users/Admin/Desktop/RED DOT/EnglishFeedback.xlsx')
...
def generate_respondents_plotsH(data, plot_type):
    if plot_type == "Gender Distribution":
        ...
        org_counts = data['Name of Organization/Institute'].value_counts().reset_index()
        ...
        for col in understanding_columns:
            understanding_counts = data[col].value_counts().reset_index()
        ...
        knowledge_counts = data['The instructor was knowledgeable and prepared.'].value_counts().reset_index()
        knowledge_counts.columns = ['Knowledge Level', 'count']
        engagement_counts = data['The instructor was engaging and encouraged participation.'].value_counts().reset_index()
...
def generate_trainer_plotsH(trainer_data):
    present_count = trainer_data['The presentation was easy to understand.'].value_counts().reset_index()
    ...
    knowledge_counts = trainer_data['The instructor was knowledgeable and prepared.'].value_counts().reset_index()
    ...
    engagement_counts = trainer_data['The instructor was engaging and encouraged participation.'].value_counts().reset_index()
...
def generate_respondents_plotsE(data, plot_type):
    if plot_type == "Gender Distribution":
        ...
        org_counts = data['Name of Organization / Institution '].value_counts().reset_index()
        ...
        place_counts = data['Location '].value_counts().reset_index()
        ...
        knowledge_counts = data['The trainer was knowledgeable and prepared.'].value_counts().reset_index()
        knowledge_counts.columns = ['Knowledge Level', 'count']
...
def generate_trainer_plotsE(trainer_data):
    ...
    knowledge_counts = trainer_data['The trainer was knowledgeable and prepared.'].value_counts().reset_index()
    ...
    engagement_counts = trainer_data['The trainer was engaging and encouraged participation.'].value_counts().reset_index()
